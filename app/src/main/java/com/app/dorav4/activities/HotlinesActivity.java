...
public class HotlinesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // cv100 OnClickListener
        cv911.setOnClickListener(v -> callNumber("100", "National Emergency"));

        // cv108 OnClickListener
        cv1555.setOnClickListener(v -> callNumber("108", "Department of Health"));

        // cv81696575 OnClickListener
        cv143.setOnClickListener(v -> callNumber("81696575", "NDRF"));

        // cv1098 OnClickListener
        cv163.setOnClickListener(v -> callNumber("1098", "CHILDLINE"));

        // cv112 OnClickListener
        cv8888.setOnClickListener(v -> callNumber("112", "Emergency Response Support System"));
    }
